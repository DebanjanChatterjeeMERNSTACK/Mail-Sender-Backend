...
route.put("/updatetemplete/:id",authenticate,authorize(["user"]),upload.single("cvLink"),Templete.templeteUpdate )
route.delete("/deletetemplete/:id",authenticate,authorize(["user"]),Templete.templeteDelete )
